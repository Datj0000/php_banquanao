...
!function (a, b) {
  "function" == typeof define && define.amd ? define("Chartist", [], function () {
    return a.Chartist = b();
  }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = b() : a.Chartist = b();
}(void 0, function () {
  var a = {
    version: "0.10.0"
  };
      ...
      j.raw.series.forEach(function (a, b) {
        ...
        if (0 !== j.normalized.series[g] || !a.ignoreEmptyValues) {
          ...
          var r = c.polarToCartesian(n.x, n.y, f, q),
              ...
              t = new c.Svg.Path(!a.donut).move(s.x, s.y).arc(f, f, 0, p - l > 180, 0, r.x, r.y);
