...
(function (d) {
  ...
  d.widget("ui.autocomplete", {
    ...
    _response: function _response(a) {
    ...
    _normalize: function _normalize(a) {
    ...
    _renderMenu: function _renderMenu(a, b) {
      var g = this;
      d.each(b, function (c, f) {
        g._renderItem(a, f);
      });
    },
    _renderItem: function _renderItem(a, b) {
...
(function (d) {
  d.widget("ui.menu", {
    ...
    activate: function activate(e, a) {
      this.deactivate();
    ...
    nextPage: function nextPage(e) {
      if (this.hasScroll()) {
        if (!this.active || this.last()) this.activate(e, this.element.children(".ui-menu-item:first"));else {
    ...
    previousPage: function previousPage(e) {
      if (this.hasScroll()) {
        if (!this.active || this.first()) this.activate(e, this.element.children(".ui-menu-item:last"));else {
          var a = this.active.offset().top,
              b = this.element.height();
