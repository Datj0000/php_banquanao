  ...
  tinymce.create('tinymce.plugins.NonEditablePlugin', {
    init: function init(ed, url) {
      ...
      ed.onNodeChange.addToTop(function (ed, cm, n) {
        var sc, ec; // Block if start or end is inside a non editable element
    ...
    _block: function _block(ed, e) {
      var k = e.keyCode; // Don't block arrow keys, pg up/down, and F1-F12

      if (k > 32 && k < 41 || k > 111 && k < 124) return;
      return Event.cancel(e);
    },
    _setDisabled: function _setDisabled(s) {
      var t = this,
          ed = t.editor;
