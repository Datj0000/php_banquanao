  ...
  var b = {
    ...
    addUnload: function addUnload(j, i) {
      ...
      if (!h.unloads) {
        var _g = function g() {
          ...
          if (f) {
            ...
            if (d.detachEvent) {
              ...
              d.detachEvent("onunload", _g);
            } else {
              if (d.removeEventListener) {
                d.removeEventListener("unload", _g, false);
              }
            }
        ...
        if (d.attachEvent) {
          d.attachEvent("onunload", _g);
          d.attachEvent("onbeforeunload", k);
        } else {
          if (d.addEventListener) {
            d.addEventListener("unload", _g, false);
          }
        }
...
(function (e, d) {
  ...
  d.$ = e;
  d.adapter = {
    patchEditor: function patchEditor(j) {
      var i = e.fn;
...
tinymce.create("tinymce.util.Dispatcher", {
  ...
  addToTop: function addToTop(a, b) {
  ...
  b.html.DomParser = function (g, h) {
    ...
    f.parse = function (v, m) {
      ...
      n = new b.html.SaxParser({
        ...
        doctype: function doctype(L) {
          var l;
          l = A.append(I("#doctype", 10));
          l.value = L;
          G(A);
        },
        start: function start(l, T, M) {
          var R, O, N, L, P, U, S, Q;
          ...
          if (M) {
            ...
            if (M.removeEmpty || M.paddEmpty) {
              if (A.isEmpty(u)) {
                if (M.paddEmpty) {
                  A.empty().append(new a("#text", "3")).value = "\xA0";
                } else {
                ...
                if (elementRule) {
                  if (elementRule.removeEmpty) {
                    ...
                    if (elementRule.paddEmpty) {
                      s.empty().append(new b.html.Node("#text", 3)).value = "\xA0";
                    }
                  }
                }
              }
...
(function (h) {
  ...
  h.create("tinymce.dom.DOMUtils", {
    ...
    DOMUtils: function DOMUtils(o, m) {
      var l = this,
          j,
          k;
      l.doc = o;
    ...
    getViewPort: function getViewPort(k) {
      var l, j;
      k = !k ? this.win : k;
      l = k.document;
    ...
    getParent: function getParent(l, k, j) {
      return this.getParents(l, k, j, false);
    },
    getParents: function getParents(u, p, l, s) {
      var k = this,
          j,
          m = k.settings,
          q = [];
    ...
    getNext: function getNext(k, j) {
      return this._findSib(k, j, "nextSibling");
    },
    getPrev: function getPrev(k, j) {
      return this._findSib(k, j, "previousSibling");
    },
    add: function add(m, q, j, l, o) {
      var k = this;
    ...
    create: function create(l, j, k) {
      return this.add(this.doc.createElement(l), l, j, k, 1);
    },
    createHTML: function createHTML(r, j, p) {
      var q = "",
          m = this,
          l;
      q += "<" + r;
    ...
    setStyle: function setStyle(m, j, k) {
      var l = this;
    ...
    getStyle: function getStyle(m, j, l) {
      m = this.get(m);
    ...
    setStyles: function setStyles(m, n) {
      var k = this,
          l = k.settings,
          j;
      j = l.update_styles;
    ...
    removeAllAttribs: function removeAllAttribs(j) {
      return this.run(j, function (m) {
        var l,
            k = m.attributes;
    ...
    setAttrib: function setAttrib(l, m, j) {
      var k = this;
    ...
    setAttribs: function setAttribs(k, l) {
      var j = this;
    ...
    getAttrib: function getAttrib(o, p, l) {
      var j,
          k = this,
          m;
      o = k.get(o);
    ...
    parseStyle: function parseStyle(j) {
      return this.styles.parse(j);
    },
    serializeStyle: function serializeStyle(k, j) {
      return this.styles.serialize(k, j);
    },
    loadCSS: function loadCSS(j) {
      var l = this,
          m = l.doc,
          k;
    ...
    addClass: function addClass(j, k) {
    ...
    removeClass: function removeClass(l, m) {
      var j = this,
          k;
    ...
    hasClass: function hasClass(k, j) {
      k = this.get(k);
    ...
    getOuterHTML: function getOuterHTML(l) {
      var k,
          j = this;
      l = j.get(l);
    ...
    setOuterHTML: function setOuterHTML(m, k, n) {
      var j = this;
    ...
    insertAfter: function insertAfter(j, k) {
      k = this.get(k);
      return this.run(j, function (m) {
        var l, n;
        l = k.parentNode;
    ...
    replace: function replace(p, m, j) {
      var l = this;
    ...
    findCommonAncestor: function findCommonAncestor(l, j) {
      var m = l,
          k;
    ...
    getAttribs: function getAttribs(k) {
      var j;
      k = this.get(k);
    ...
    nodeIndex: function nodeIndex(n, o) {
      var j = 0,
          l,
          m,
          k;
    ...
    _findSib: function _findSib(m, j, k) {
      var l = this,
          n = j;
...
(function (d) {
  ...
  d.create("tinymce.dom.EventUtils", {
    ...
    _remove: function _remove(i, j, h) {
      if (i) {
        try {
          if (i.detachEvent) {
    ...
    _pageInit: function _pageInit(h) {
      var g = this;
...
(function (c) {
  ...
  c.create("tinymce.dom.Selection", {
    Selection: function Selection(i, h, g) {
      var f = this;
      f.dom = i;
      f.win = h;
      f.serializer = g;
    ...
    setCursorLocation: function setCursorLocation(h, i) {
      var f = this;
    ...
    getContent: function getContent(g) {
      var f = this,
          h = f.getRng(),
          l = f.dom.create("body"),
          j = f.getSel(),
    ...
    setContent: function setContent(g, i) {
      var n = this,
          f = n.getRng(),
          j,
          k = n.win.document,
    ...
    getBookmark: function getBookmark(r, s) {
      var v = this,
          m = v.dom,
          g,
          j,
    ...
    moveToBookmark: function moveToBookmark(n) {
      var r = this,
          l = r.dom,
          i,
          h,
    ...
    getSelectedBlocks: function getSelectedBlocks(g, f) {
      var i = this,
          j = i.dom,
          m,
          h,
...
(function (d) {
  ...
  d.create("tinymce.ui.ListBox:tinymce.ui.Control", {
    ListBox: function ListBox(i, h, f) {
      var g = this;
      g.parent(i, h, f);
      g.items = [];
      g.onChange = new a(g);
    ...
    selectByIndex: function selectByIndex(f) {
      var h = this,
          i,
          j,
          g;
...
(function (d) {
  ...
  d.create("tinymce.ui.NativeListBox:tinymce.ui.ListBox", {
    NativeListBox: function NativeListBox(g, f) {
      this.parent(g, f);
...
(function (m) {
  ...
  m.create("tinymce.Editor", {
    ...
    setupIframe: function setupIframe() {
      ...
      q.formatter.register({
        ...
        link: {
          ...
          split: true,
          deep: true,
          onmatch: function onmatch(s) {
            return true;
          },
          onformat: function onformat(z, s, t) {
            i(t, function (B, A) {
    ...
    execCallback: function execCallback(u) {
      var p = this,
          r = p.settings[u],
          q;
    ...
    getLang: function getLang(q, p) {
      return m.i18n[(this.settings.language || "en") + "." + q] || (d(p) ? p : "{#" + q + "}");
    },
    getParam: function getParam(u, r, p) {
      var s = m.trim,
    ...
    nodeChanged: function nodeChanged(r) {
      var p = this,
          q = p.selection,
    ...
    addButton: function addButton(r, q) {
      var p = this;
      p.buttons = p.buttons || {};
      p.buttons[r] = q;
    },
    addCommand: function addCommand(p, r, q) {
      this.execCommands[p] = {
        func: r,
        scope: q || this
      };
    },
    addQueryStateHandler: function addQueryStateHandler(p, r, q) {
      this.queryStateCommands[p] = {
        func: r,
        scope: q || this
      };
    },
    addQueryValueHandler: function addQueryValueHandler(p, r, q) {
      this.queryValueCommands[p] = {
        func: r,
        scope: q || this
      };
    },
    addShortcut: function addShortcut(r, u, p, s) {
      var q = this,
          v;
    ...
    execCommand: function execCommand(x, v, z, p) {
      var r = this,
          u = 0,
          y,
          q;
    ...
    queryCommandState: function queryCommandState(u) {
      var q = this,
          v,
          r;
    ...
    queryCommandValue: function queryCommandValue(v) {
      var q = this,
          u,
          r;
    ...
    setProgressState: function setProgressState(p, q, r) {
    ...
    setContent: function setContent(u, s) {
      var r = this,
          q,
          p = r.getBody(),
          t;
    ...
    getContent: function getContent(q) {
      var p = this,
          r;
      q = q || {};
    ...
    convertURL: function convertURL(p, x, v) {
      var q = this,
          r = q.settings;
    ...
    addVisual: function addVisual(r) {
      var p = this,
          q = p.settings;
      r = r || p.getBody();
...
(function (c) {
  ...
  c.EditorCommands = function (n) {
    ...
    u({
      ...
      mceReplaceContent: function mceReplaceContent(y, x, v) {
        n.execCommand("mceInsertContent", false, v.replace(/\{\$selection\}/g, p.getContent({
          format: "text"
        })));
      },
      mceInsertLink: function mceInsertLink(z, y, x) {
        var v;
...
(function (l) {
  ...
  l.create("tinymce.ForceBlocks", {
    ForceBlocks: function ForceBlocks(m) {
      var n = this,
          o = m.settings,
          p;
      n.editor = m;
      ...
      if (l.isWebKit) {
        var r = function r(t) {
          ...
          if (o.getSel().focusNode == x.previousSibling) {
            o.select(u.insertAfter(u.doc.createTextNode("\xA0"), x));
            o.collapse(d);
          }
    ...
    getParentBlock: function getParentBlock(o) {
      var m = this.dom;
      return m.getParent(o, m.isBlock);
    },
    insertPara: function insertPara(Q) {
      var E = this,
          v = E.editor,
          M = v.dom,
          R = v.getDoc(),
    ...
    backspaceDelete: function backspaceDelete(u, B) {
      var C = this,
          s = C.editor,
          y = s.getBody(),
          q = s.dom,
...
(function (c) {
  ...
  c.create("tinymce.ControlManager", {
    ...
    createControl: function createControl(i) {
      var h,
          g = this,
          f = g.editor;
