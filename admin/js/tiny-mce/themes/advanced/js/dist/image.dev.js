...
var ImageDialog = {
  ...
  updateStyle: function updateStyle() {
    ...
    if (tinyMCEPopup.editor.settings.inline_styles) {
      st = tinyMCEPopup.dom.parseStyle(this.styleVal); // Handle align
      ...
      if (v || v == '0') {
        if (v == '0') st['border'] = '0';else st['border'] = v + 'px solid black';
      } else delete st['border']; // Handle hspace
  ...
  updateImageData: function updateImageData() {
    ...
    if (f.height.value == "") f.height.value = t.preloadImg.height;
  },
