...
(function (e) {
  ...
  e.create("tinymce.themes.AdvancedTheme", {
    ...
    createControl: function createControl(l, i) {
      var j, k;
    ...
    execCommand: function execCommand(k, j, l) {
      var i = this["_" + k];
    ...
    _importClasses: function _importClasses(k) {
      var i = this.editor,
          j = i.controlManager.get("styleselect");
    ...
    _createStyleSelect: function _createStyleSelect(m) {
      var k = this,
          i = k.editor,
          j = i.controlManager,
          l;
    ...
    _simpleLayout: function _simpleLayout(y, r, k, i) {
      var x = this,
          u = x.editor,
          v = y.theme_advanced_toolbar_location,
          m = y.theme_advanced_statusbar_location,
          l,
          j,
          q,
          w;
    ...
    _rowLayout: function _rowLayout(w, m, k) {
      var v = this,
          p = v.editor,
          u,
          x,
    ...
    _addControls: function _addControls(j, i) {
      var k = this,
          l = k.settings,
          m,
          n = k.editor.controlManager;
    ...
    _addToolbars: function _addToolbars(x, k) {
      var A = this,
          p,
          m,
          r = A.editor,
    ...
    _addStatusBar: function _addStatusBar(m, j) {
      var k,
          v = this,
          p = v.editor,
          w = v.settings,
    ...
    _updateUndoStatus: function _updateUndoStatus(j) {
      var i = j.controlManager,
          k = j.undoManager;
      i.setDisabled("undo", !k.hasUndo() && !k.typing);
      i.setDisabled("redo", !k.hasRedo());
    },
    _nodeChanged: function _nodeChanged(m, r, D, q, E) {
      var y = this,
          C,
          F = 0,
          x,
    ...
    _sel: function _sel(i) {
      this.editor.execCommand("mceSelectNodeDepth", false, i);
    },
    _mceInsertAnchor: function _mceInsertAnchor(k, j) {
      var i = this.editor;
    ...
    _mceColorPicker: function _mceColorPicker(k, j) {
      var i = this.editor;
      j = j || {};
      i.windowManager.open({
    ...
    _mceCodeEditor: function _mceCodeEditor(j, k) {
      var i = this.editor;
      i.windowManager.open({
    ...
    _mceImage: function _mceImage(j, k) {
      var i = this.editor;
    ...
    _mceLink: function _mceLink(j, k) {
      var i = this.editor;
      i.windowManager.open({
