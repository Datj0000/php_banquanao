...
(function (i, za, p) {
  ...
  n.oPagination = {
    two_button: {
      ...
      fnUpdate: function fnUpdate(g) {
        if (g.aanFeatures.p) for (var l = g.aanFeatures.p, s = 0, t = l.length; s < t; s++) {
  ...
  i.fn.dataTable = function (g) {
    ...
    function X(a) {
      ...
      if (a.oFeatures.bSort) for (b = 0; b < a.aoColumns.length; b++) {
    ...
    function V(a) {
      ...
      if (a.oFeatures.bSort && a.oFeatures.bSortClasses) {
        d = Q(a);
        if (a.oFeatures.bDeferRender) i(d).removeClass(e + "1 " + e + "2 " + e + "3");else if (d.length >= h) for (b = 0; b < h; b++) {
      ...
      for (f = f; f < k; f++) {
        ...
        if (j.nTr !== null) {
          ...
          for (h = a.aoColumns.length; e < h; e++) {
            if (a.aoColumns[e].bVisible) c.push(b[e - d]);else {
    ...
    function Xa(a, b) {
      if (a.oFeatures.bStateSave) {
        ...
        if (d !== null && d !== "") {
          ...
          if (typeof c.aaSearchCols != "undefined") for (d = 0; d < c.aaSearchCols.length; d++) {
            a.aoPreSearchCols[d] = {
    ...
    return this.each(function () {
      ...
      if (this.nodeName.toLowerCase() != "table") J(e, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName);else {
        ...
        if (j) for (a = 0; a < g.aaData.length; a++) {
          v(e, g.aaData[a]);
        } else $(e);
