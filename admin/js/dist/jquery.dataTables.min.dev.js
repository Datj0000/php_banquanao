 ...
 *   https://datatables.net/download/#bs/jq-3.3.1/dt-1.10.24/af-2.3.6/r-2.2.7/rg-1.1.2/rr-1.2.7
 *
 * Included libraries:
 *  jQuery 3.3.1, DataTables 1.10.24, AutoFill 2.3.6, Responsive 2.2.7, RowGroup 1.1.2, RowReorder 1.2.7
 */
...
(function (k) {
  ...
  function Hb(a) {
    ...
    for (var f = a.sDom.split(""), g, h, l, n, m, p, t = 0; t < f.length; t++) {
      ...
      if ("<" == h) {
        ...
        e.append(l);
        e = k(l);
      } else if (">" == h) e = e.parent();else if ("l" == h && d.bPaginate && d.bLengthChange) g = Ib(a);else if ("f" == h && d.bFilter) g = Jb(a);else if ("r" == h && d.bProcessing) g = Kb(a);else if ("t" == h) g = Lb(a);else if ("i" == h && d.bInfo) g = Mb(a);else if ("p" == h && d.bPaginate) g = Nb(a);else if (0 !== u.ext.feature.length) for (l = u.ext.feature, p = 0, n = l.length; p < n; p++) {
        if (h == l[p].cFeature) {
          g = l[p].fnInit(a);
          break;
        }
  ...
  function kb(a, b, c) {
    var d = a._iDisplayStart,
        e = a._iDisplayLength,
        f = a.fnRecordsDisplay();
    0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "first" == b ? d = 0 : "previous" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "next" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : aa(a, 0, "Unknown paging action: " + b, 5);
  ...
  function Ea(a) {
    ...
    if (a.scrollBarVis !== ha && a.scrollBarVis !== q) a.scrollBarVis = ha, ra(a);else {
      ...
      f = r.outerWidth();
      "" === c ? (E.width = "100%", M && (r.find("tbody").height() > h.offsetHeight || "scroll" == m.css("overflow-y")) && (E.width = K(r.outerWidth() - b)), f = r.outerWidth()) : "" !== d && (E.width = K(d), f = r.outerWidth());
      Z(Yb, ha);
      Z(function (F) {
        X.push(F.innerHTML);
      ...
      if (h && h.time) {
        ...
        if (-1 === k.inArray(!1, l) && (l = a.iStateDuration, !(0 < l && h.time < +new Date() - 1E3 * l || h.columns && f.length !== h.columns.length))) {
          ...
          if (h.columns) for (d = 0, e = h.columns.length; d < e; d++) {
            l = h.columns[d], l.visible !== q && (f[d].bVisible = l.visible), l.search !== q && k.extend(a.aoPreSearchCols[d], Vb(l.search));
          }
  ...
  u.defaults = {
    ...
    oLanguage: {
      ...
      sInfoEmpty: "Hiển thị 0 đến 0 của 0 hàng",
      sInfoFiltered: "(filtered from _MAX_ total entries)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Hiện thị _MENU_ hàng",
  ...
  u.ext = L = {
    buttons: {},
    classes: {},
    builder: "bs/jq-3.3.1/dt-1.10.24/af-2.3.6/r-2.2.7/rg-1.1.2/rr-1.2.7",
    errMode: "alert",
    feature: [],
    search: [],
    selector: {
...
$jscomp.SIMPLE_FROUND_POLYFILL = !1;
$jscomp.ISOLATE_POLYFILLS = !1;
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function (c, h, g) {
...
$jscomp.getGlobal = function (c) {
  c = ["object" == (typeof globalThis === "undefined" ? "undefined" : _typeof(globalThis)) && globalThis, c, "object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window, "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self, "object" == (typeof global === "undefined" ? "undefined" : _typeof(global)) && global];
...
var $jscomp$lookupPolyfilledValue = function $jscomp$lookupPolyfilledValue(c, h) {
...
$jscomp.polyfillUnisolated = function (c, h, g, k) {
  ...
  k = g[c];
  h = h(k);
  h != k && null != h && $jscomp.defineProperty(g, c, {
    configurable: !0,
    writable: !0,
    value: h
  });
...
$jscomp.polyfillIsolated = function (c, h, g, k) {
  ...
  h = h(g);
  null != h && (c ? $jscomp.defineProperty($jscomp.polyfills, l, {
    configurable: !0,
    writable: !0,
    value: h
  }) : h !== g && ($jscomp.propertyToPolyfillSymbol[l] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(l) : $jscomp.POLYFILL_PREFIX + l, l = $jscomp.propertyToPolyfillSymbol[l], $jscomp.defineProperty(k, l, {
    configurable: !0,
    writable: !0,
    value: h
  })));
...
(function (c) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (h, g) {
    h || (h = window);
  ...
  c.extend(r.prototype, {
    ...
    _attach: function _attach(a) {
      var d = this.s.dt,
          b = d.cell(a).index(),
          e = this.dom.handle,
          f = this.s.handle;
      b && -1 !== d.columns(this.c.columns).indexes().indexOf(b.column) ? (this.dom.offsetParent || (this.dom.offsetParent = c(d.table().node()).offsetParent()), f.height && f.width || (e.appendTo("body"), f.height = e.outerHeight(), f.width = e.outerWidth()), d = this._getPosition(a, this.dom.offsetParent), this.dom.attachedTo = a, e.css({
        top: d.top + a.offsetHeight - f.height,
        left: d.left + a.offsetWidth - f.width
      }).appendTo(this.dom.offsetParent)) : this._detach();
    },
    _actionSelector: function _actionSelector(a) {
      var d = this,
          b = this.s.dt,
          e = r.actions,
          f = [];
      ...
      if (1 === f.length && !1 === this.c.alwaysAsk) {
        ...
        c.each(f, function (p, q) {
          n.append(c("<li/>").append('<div class="dt-autofill-question">' + e[q].option(b, a) + "<div>").append(c('<div class="dt-autofill-button">').append(c('<button class="' + r.classes.btn + '">' + b.i18n("autoFill.button", "&gt;") + "</button>").on("click", function () {
    ...
    _emitEvent: function _emitEvent(a, d) {
    ...
    _focusListener: function _focusListener() {
      ...
      if ("focus" === e) d.on("key-focus.autoFill", function (f, m, n) {
        a._attach(n.node());
      }).on("key-blur.autoFill", function (f, m, n) {
        a._detach();
      });else if ("click" === e) c(d.table().body()).on("click" + b, "td, th", function (f) {
        a._attach(this);
      }), c(g.body).on("click" + b, function (f) {
        c(f.target).parents().filter(d.table().body()).length || a._detach();
      });else c(d.table().body()).on("mouseenter" + b, "td, th", function (f) {
        a._attach(this);
    ...
    _getPosition: function _getPosition(a, d) {
      var b = 0,
          e = 0;
    ...
    _mousedown: function _mousedown(a) {
      ...
      this.s.start = {
        row: b.rows({
          page: "current"
        }).nodes().indexOf(c(this.dom.start).parent()[0]),
        column: c(this.dom.start).index()
      };
      c(g.body).on("mousemove.autoFill", function (f) {
        d._mousemove(f);
    ...
    _mouseup: function _mouseup(a) {
      ...
      if (e.row !== f.row || e.column !== f.column) {
        var m = b.cell(":eq(" + e.row + ")", e.column + ":visible", {
          page: "current"
        });
        ...
        if (c("div.DTE", m.node()).length) {
          ...
          for (var q = b.settings()[0], v = q.aoColumns, u = b.columns(this.c.columns).indexes(), w = 0; w < p.length; w++) {
            f.push(c.map(e, function (t) {
              ...
              if (-1 !== u.indexOf(z.column)) return {
                cell: t,
                data: x,
                label: t.data(),
                index: z
    ...
    _shiftScroll: function _shiftScroll(a) {
      var d = this,
          b = this.s.scroll,
          e = !1,
    ...
    fill: {
      ...
      execute: function execute(a, d, b) {
        ...
        for (var e = d.length; b < e; b++) {
          for (var f = 0, m = d[b].length; f < m; f++) {
            d[b][f].set = a;
          }
        }
      }
    ...
    fillHorizontal: {
      ...
      execute: function execute(a, d, b) {
        ...
        for (b = d.length; a < b; a++) {
          for (var e = 0, f = d[a].length; e < f; e++) {
            d[a][e].set = d[a][0].data;
          }
        }
      }
    },
...
(function (b) {
  "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs", "datatables.net-autofill"], function (a) {
    return b(a, window, document);
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (a, c) {
    a || (a = window);
    c && c.fn.dataTable || (c = require("datatables.net-bs")(a, c).$);
...
(function (a) {
  ...
  c.modal = function (g) {
    return function (k, h, l) {
      if (!a.fn.modal) d(k, h, l);else if (!h) {
        if (g && g.header) {
...
(function (a) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (c, d) {
    c || (c = window);
  ...
  a.extend(g.prototype, {
    ...
    _group: function _group(b, d) {
      ...
      if (h[b + 1] !== f) for (k = 0, p = m.length; k < p; k++) {
    ...
    _rowWrap: function _rowWrap(b, d, c) {
      if (null === b || "" === b) b = this.c.emptyDataGroup;
      return b === f || null === b ? null : ("object" === _typeof(b) && b.nodeName && "tr" === b.nodeName.toLowerCase() ? a(b) : b instanceof a && b.length && "tr" === b[0].nodeName.toLowerCase() ? b : a("<tr/>").append(a("<td/>").attr("colspan", this._colspan()).append(b))).addClass(this.c.className).addClass(d).addClass("dtrg-level-" + c);
    }
  });
  g.defaults = {
    ...
    startRender: function startRender(b, a) {
      return a;
    }
  };
  g.version = "1.1.2";
...
(function (c) {
  "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs", "datatables.net-rowgroup"], function (a) {
...
(function (a) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (f, d) {
    f || (f = window);
  ...
  var g = a.fn.dataTable,
    ...
    this.c = a.extend(!0, {}, g.defaults.rowReorder, h.defaults, e);
    this.s = {
      bodyTop: null,
      dt: new g.Api(b),
    ...
    this.dom.dtScroll.length || (this.dom.dtScroll = a(this.s.dt.table().container(), "tbody"));
    b.rowreorder = this;
  ...
  a.extend(h.prototype, {
    ...
    _clonePosition: function _clonePosition(a) {
      var b = this.s.start,
          c = this._eventToPage(a, "Y") - b.top;
      a = this._eventToPage(a, "X") - b.left;
      var d = this.c.snapX;
      c += b.offsetTop;
    ...
    _mouseMove: function _mouseMove(b) {
      ...
      null === d && (d = c.length);
      if (null === this.s.lastInsert || this.s.lastInsert !== d) e = a.unique(f.rows({
        page: "current"
    ...
    _shiftScroll: function _shiftScroll(b) {
      var e = this,
          c = this.s.scroll,
          g = !1,
      ...
      k || m ? (c.windowVert = k, c.dtVert = m, g = !0) : this.s.scrollInterval && (clearInterval(this.s.scrollInterval), this.s.scrollInterval = null);
  ...
  a(d).on("init.dt.dtr", function (b, d, c) {
    "dt" === b.namespace && (b = d.oInit.rowReorder, c = g.defaults.rowReorder, b || c) && (c = a.extend({}, b, c), !1 !== b && new h(d, c));
  });
  return h;
});
/*!
...
(function (c) {
  "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs", "datatables.net-rowreorder"], function (a) {
    return c(a, window, document);
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (a, b) {
    a || (a = window);
    b && b.fn.dataTable || (b = require("datatables.net-bs")(a, b).$);
